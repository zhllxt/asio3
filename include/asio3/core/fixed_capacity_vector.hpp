...
namespace std::experimental::fcv_detail
{
    namespace
    {
        // https://en.cppreference.com/w/cpp/utility/unreachable
        [[noreturn]] inline void __fcv_unreachable()
        {
...
/// Unreachable code
#define FCV_UNREACHABLE std::experimental::fcv_detail::__fcv_unreachable()

/// Optimizer allowed to assume that EXPR evaluates to true
#define FCV_ASSUME(EXPR) \
    static_cast<void>((EXPR) ? void(0) : std::experimental::fcv_detail::__fcv_unreachable())
