...
//	asio::event_dispatcher<int, void ()> dispatcher;
//
...
//	asio::event_dispatcher<int, void (const std::string &, const bool)> dispatcher;
//
...
//		using thread_t = asio::dispatcheres::single_thread;
//	};
//
...
//
//	asio::event_dispatcher<int, void (const Tutor4MyEvent &), Tutor4MyEventPolicies> dispatcher;
//
...
//
//	struct MyPolicies {
//		using mixins_t = asio::dispatcheres::mixin_list<asio::dispatcheres::mixin_filter>;
//	};
//	asio::event_dispatcher<int, void (int e, int i, std::string), MyPolicies> dispatcher;
//
...
template <
	...
	template <typename > class SharedLockT = std::shared_lock,
	template <typename > class UniqueLockT = std::unique_lock,
