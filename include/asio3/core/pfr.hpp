...
#else
#include <asio3/bho/core/type_name.hpp>
#endif
...
#if !defined(ASIO3_HEADER_ONLY) && __has_include(<boost/pfr.hpp>)
#include <boost/pfr.hpp>
namespace pfr = ::boost::pfr;
#else
#include <asio3/bho/pfr.hpp>
...
#define BHO_REFLECT_FIELD_INDEX(name) ASIO3_JOIN(__reflect_index_, name)
