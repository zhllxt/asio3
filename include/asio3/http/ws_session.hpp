...
#include <asio3/http/impl/ws_stream_cp.hpp>
#include <asio3/http/impl/ws_send_op.hpp>
#include <asio3/http/request.hpp>
#include <asio3/http/response.hpp>
...
namespace asio::detail
{
	...
	protected:
			...
			std::shared_ptr<derived_t> this_ptr, std::shared_ptr<ecs_t<C>> ecs, DeferEvent chain)
		{
			...
			assert(!ec);
			assert(derive.sessions_.io_->running_in_this_thread());
	...
	protected:
		...
		inline void _fire_upgrade(std::shared_ptr<derived_t>& this_ptr)
		{
			...
			assert(this->sessions_.io_->running_in_this_thread());
