...
#include <asio3/http/detail/flex_body.hpp>
...
#endif
{
	...
	{
		template<class> friend class asio::detail::http_router_t;
...
namespace asio::detail
{
	...
	class http_response_impl_t : public http::message<false, Body, Fields>
	{
		template<class> friend class asio::detail::http_router_t;
...
#endif
{
	using web_response = asio::detail::http_response_impl_t<http::flex_body>;
}
