...
#include <asio3/bho/move/detail/workaround.hpp>  //forceinline
#include <asio3/bho/move/detail/unique_ptr_meta_utils.hpp>
#include <asio3/bho/move/default_delete.hpp>
