...
# error "<asio3/bho/endian/endian.hpp> is deprecated. Define BHO_ENDIAN_DEPRECATED_NAMES to use."
#endif

#include <asio3/bho/config/header_deprecated.hpp>

BHO_HEADER_DEPRECATED( "<asio3/bho/endian/arithmetic.hpp>" )

#include <asio3/bho/endian/arithmetic.hpp>
