...
#  define BHO_ABI_PREFIX "asio3/bho/config/abi/msvc_prefix.hpp"
#endif
#ifndef BHO_ABI_SUFFIX
#  define BHO_ABI_SUFFIX "asio3/bho/config/abi/msvc_suffix.hpp"
#endif
...
#include <asio3/bho/config/pragma_message.hpp>
